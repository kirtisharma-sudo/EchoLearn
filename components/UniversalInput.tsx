...
const UniversalInput: React.FC<UniversalInputProps> = ({ featureTitle, isProcessing, onSubmit, onCancel }) => {
  ...
  const startRecording = async () => {
    try {
      ...
      alert("Could not access microphone. Please use text input.");
    }
  };
  ...
  return (
    <div className="w-full max-w-3xl mx-auto animate-slide-up">
        ...
        {isRecording ? (
          ...
          <div className="space-y-4">
            <textarea
              ...
              placeholder="Type your topic, question, or problem here..."
      ...
      <div className="mt-6 text-center text-slate-500 text-sm">
        EchoLearn supports both voice and text input. Try explaining a concept aloud!
      </div>
    </div>
  );
};
